angular.module('routes', []).config(function ($routeProvider) {
    ...
    .when('/Contents/Retailer',{  controller: 'ContentsController',          templateUrl: 'Views/List.view.html',    controllerAs: 'vm' })
    ...
    // LoyaltyRewards
    .when('/LoyaltyRewards/Retailer',{controller: 'LoyaltyRewardsController',templateUrl: 'Views/List.view.html',    controllerAs: 'vm' })
