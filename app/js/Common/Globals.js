myApp.value('Globals', {
  ...
  "BorderChartColours" : [  "rgba(0,255,0,.8)" ,"rgba(255,0,0,.8)"  ,"rgba(0,0,255,.8)"    ,"rgba(255,255,0,.8)",
  ...
  "LoyaltyRewardColumnDefs2" : [{
    ...
    {  field : 'rewardImage',    width : '20%',  displayName : 'Reward Image',enableCellEdit : true,headerCellClass: 'white',
      cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserRewardImage.html",
  ...
  "RetailerColumnDefs" : [{
    ...
    "RetailerColumnDefs2" : [{
      ...
      { name: 'Actions', width : '10%',enableCellEdit : false, pinnedRight:true, headerCellClass: 'white',
        cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateActions.html"
      ...
      {  field : 'defaultContentPage2',               width : '20%',   displayName : 'Default Content Page 2',      enableCellEdit : true, headerCellClass: 'white',
        cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserDCPage2.html",
      },
      {  field : 'defaultContentPage3',               width : '20%',   displayName : 'Default Content Page 3',      enableCellEdit : true, headerCellClass: 'white',
        cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserDCPage3.html",
      },
      {  field : 'defaultLoyaltyRewardImage',         width : '20%',   displayName : 'Default Loyalty Reward Image',enableCellEdit : true,headerCellClass: 'white',
        cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserDLRImage.html",
      },
      {  field : 'facebookUrl',                       width : '20%',   displayName : 'Facebook Url',               enableCellEdit : true, headerCellClass: 'white',  },
      {  field : 'twitterUrl',                        width : '20%',   displayName : 'Twitter Url',                enableCellEdit : true, headerCellClass: 'white',  },
      {  field : 'websiteUrl',                        width : '18%',   displayName : 'Website Url',                enableCellEdit : true, headerCellClass: 'white',  },
      {  field : 'logoImageSmall',                    width : '15%',  displayName : 'Logo Image Small',           enableCellEdit : true, headerCellClass: 'white',
        cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserLISmall.html",
      },
      {  field : 'logoImageLarge',                    width : '15%',  displayName : 'Logo Image Large',           enableCellEdit : true, headerCellClass: 'white',
        cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserLIMedium.html",
      },
      {  field : 'logoImageMedium',                   width : '15%',  displayName : 'Logo Image Medium',          enableCellEdit : true, headerCellClass: 'white',
  ...
  "RetailerColumnDefs3" : [{
    ...
    { name: 'Save', width : '8%',enableCellEdit : false, pinnedRight:true, headerCellClass: 'white',
      cellTemplate:  "/ShopTrawlerWebApp/app/Views/cellTemplateActionSave.html"
      // '<button class="btn-success btn-circle"  ng-click="grid.appScope.saveRow(row)" ><img src="images/ic_save_black_24dp_1x.png"</button>' +
      // // '<button class="btn-danger btn-circle "  ng-click="grid.appScope.deleteRow(row)" ><img src="images/ic_delete_forever_black_24dp_1x.png"></button>'+
      // '</div>'
},
  ...
  "ShoppingCentreColumnDefs" : [{
      ...
      {  field : 'fullname',       width : '12%', displayName : 'Admin ID',           enableCellEdit : true, headerCellClass: 'white', },
      {  field : 'contentPage',    width : '12%', displayName : 'Content Page',       enableCellEdit : true, headerCellClass: 'white',
        cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateSCContentPage.html",
      },
      {  field : 'phone',          width : '10%', displayName : 'Phone',              enableCellEdit : true, headerCellClass: 'white', },
      {  field : 'facebookUrl',    width : '12%', displayName : 'Facebook Url',       enableCellEdit : true, headerCellClass: 'white', },
      {  field : 'twitterUrl',     width : '12%', displayName : 'Twitter Url',        enableCellEdit : true, headerCellClass: 'white', },
      {  field : 'websiteUrl',     width : '12%', displayName : 'Website Url',        enableCellEdit : true, headerCellClass: 'white', },
    {  field : 'logoImageSmall',   width : '25%',  displayName : 'Logo Image Small',  enableCellEdit : true,  headerCellClass: 'white',
      cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserLISmall.html",
    },
    {  field : 'logoImageLarge',   width : '25%',  displayName : 'Logo Image Large',  enableCellEdit : true,  headerCellClass: 'white',
      cellTemplate: "/ShopTrawlerWebApp/app/Views/cellTemplateFileChooserLIMedium.html",
    },
